...
public class DropPushExit extends SequentialCommandGroup {
  public DropPushExit(Swerve s_Swerve) {
    ...
    PathPlannerTrajectory trajectory1 = PathPlanner.loadPath("DropPushExit", new PathConstraints(1, 1));
